...
def make_parser():
    ...
    parser.add_argument('-q', '--quantize', type=int, default=255,
                        help='Quantizes the image according to an arbitrary number of colors. Default is 256')

    parser.add_argument('-d', '--dithering', action='store_true', default=False,
                        help='Applies dithering to the image to help mitigate a narrow color pallette.')
